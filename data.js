...
const internshipsData = [
    ...
    {
        id: 16,
        title: "Summer Intern — Credit Department",
        company: "DemirBank",
        category: ["Communications"],
        location: "Bishkek",
        type: "on-site",
        paid: "unpaid",
        deadline: "Watch demirbank.kg (typically May 31)",
        description: "Annual summer practice for economics/management students. 25+ year running program.",
        applyLink: "https://demirbank.kg/ru-kg/about/staff/vacancies",
        tags: "bank finance demir summer"
    },
    {
        id: 17,
        title: "Summer Student Program (3 months PAID)",
        company: "Kumtor Gold Company",
        category: ["IT"],
        location: "Kumtor Mine (Naryn Province)",
        type: "on-site",
        paid: "paid",
        deadline: "Watch kumtor.kg (typically spring)",
        description: "PAID mining internship. Real work in mill, metallurgical lab, dispatch. 150+ hired in recent cohort.",
        applyLink: "https://www.kumtor.kg/en/people-careers/",
        tags: "mining engineering geology paid kumtor"
    },
    {
        id: 18,
        title: "Graduate Internship Program (2 years PAID)",
        company: "Kumtor Gold Company",
        category: ["IT"],
        location: "Kumtor Mine (Naryn Province)",
        type: "on-site",
        paid: "paid",
        deadline: "Watch kumtor.kg",
        description: "Two-year paid graduate development program. Rotations through mine operations with senior mentors.",
        applyLink: "https://www.kumtor.kg/en/internship-dispatch-team/",
        tags: "mining engineering graduate paid kumtor"
    },
    {
        id: 19,
        title: "Bank Intern (Credit / Operations)",
        company: "KICB",
        category: ["Communications"],
        location: "Bishkek",
        type: "on-site",
        paid: "unpaid",
        deadline: "Rolling",
        description: "Internship with path to full-time employment. Economics background preferred.",
        applyLink: "https://kicb.net/about/career/practice/",
        tags: "bank finance kicb credit"
    },
    {
        id: 20,
        title: "Program & Communications Intern (PAID)",
        ...
        paid: "paid",
        deadline: "Rolling",
        description: "Peacebuilding organization. Assist with meetings, workshops, social media content.",
        applyLink: "https://www.sfcg.org/asia/kyrgyzstan/",
        tags: "peacebuilding ngo communications paid"
    },
    {
        id: 21,
        title: "ADB Internship Program (PAID)",
        company: "Asian Development Bank",
        category: ["NGO"],
        location: "Manila / Remote",
        type: "remote",
        paid: "paid",
        deadline: "Watch adb.org (Feb & Aug cycles)",
        description: "Research internship for Master's/PhD students. Competitive stipend. Kyrgyz nationals eligible.",
        applyLink: "https://www.adb.org/work-with-us/careers/internship-program",
        tags: "adb research economics paid master phd"
    },
    {
        id: 22,
        title: "GIZ Internship",
        company: "GIZ Kyrgyzstan",
        category: ["NGO"],
        location: "Bishkek",
        type: "on-site",
        paid: "unpaid",
        deadline: "Contact directly",
        description: "German development cooperation. Focus areas: Green Economy, Health, Rural Development.",
        applyLink: "https://www.giz.de/en/jobs_and_careers/37519.html",
        tags: "giz development germany green economy"
    },
    {
        id: 23,
        title: "PwC Internship (Audit/Tax/Advisory)",
        company: "PwC Kyrgyzstan",
        category: ["Communications"],
        location: "Bishkek",
        type: "on-site",
        paid: "unpaid",
        deadline: "Check pwc.com/kz/en/careers",
        description: "Big 4 consulting. Assurance, Tax, and Advisory services.",
        applyLink: "https://www.pwc.com/kz/en/careers.html",
        tags: "pwc audit tax consulting big4"
    },
    {
        id: 24,
        title: "IOM Internship (with Monthly Allowance)",
        company: "IOM Kyrgyzstan",
        category: ["NGO"],
        location: "Bishkek",
        type: "on-site",
        paid: "paid",
        deadline: "Contact hrkg@iom.int",
        description: "Monthly Subsistence Allowance provided. HR and programme support roles.",
        applyLink: "https://kyrgyzstan.iom.int/intern",
        tags: "iom migration international allowance"
    }
];
